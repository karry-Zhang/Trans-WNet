...
def load_data():
    ...
    return x, y, t, Exact, Exact_u, Exact_v, Exact_h
...
def main(N_0, N_b, N_f, lb, ub, layers, t_test_index):
    # load data
    x, y, t, Exact, Exact_u, Exact_v, Exact_h = load_data()
    "xt_0"
...
if __name__ == '__main__':
    ...
    lb = np.array([-5, -5, 0])
    ub = np.array([5, 5, 1])
    t_test_index = [0, 50, 51, 100]
    main(N_0, N_b, N_f, lb, ub, layers, t_test_index)